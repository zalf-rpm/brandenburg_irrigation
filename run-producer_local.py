...
DATA_GRID_IRRIGATION = "germany/irrigation_100_25832_etrs89-utms32n_grains_2018.asc"
...
def run_producer(server={"server": None, "port": None}, shared_id=None):
    ...
    config = {
        "mode": "mp-local-local", #Add my own mode here
        ...
        "crop.json": "crop.json",
        "site.json": "site.json",
        "setups-file": "sim_setups_all.csv",
        "run-setups": "[56,57,58,59,60,61,62,63,64,65,66,67,68,69,70,71,72]",
        "shared_id": shared_id
    }
