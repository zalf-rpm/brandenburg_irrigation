...
PATHS = {
    "re-local-remote": {
        ...
        "path-to-output-dir": "D:/brandenburg_irrigation/out/out/",
        "path-to-csv-output-dir": "D:/brandenburg_irrigation/out/csv-out/"
    },
    "re-local-local": {
        "path-to-data-dir": "data/",
        "path-to-output-dir": "D:/brandenburg_irrigation/out/out/",
    ...
    "mp-local-local": {
        "path-to-data-dir": "data/",
        "path-to-output-dir": "C:/Users/palka/GitHub/brandenburg_irrigation/out/out/",
        "path-to-csv-output-dir": "C:/Users/palka/GitHub/brandenburg_irrigation/out/csv-out/"
    }
}
...
def write_row_to_grids(row_col_data, row, ncols, header, path_to_output_dir, path_to_csv_output_dir, setup_id):
    ...
    output_grids = {
        ...
        # "CumET": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        # "CumET": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        # "MaxLAI": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "CumIRR": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1}
    }
