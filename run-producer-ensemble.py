...
DATA_GRID_IRRIGATION = "germany/irrigation_100_25832_etrs89-utms32n_allcrops_2018.asc"
...
def run_producer(server={"server": None, "port": None}, shared_id=None):
    ...
    config = {
        ...
        "end-row": "-1",
        "path_to_dem_grid": "",
        "sim.json": "sim_proj.json",
        "crop.json": "crop.json",
        "site.json": "site.json",
        "setups-file": "sim_setups_ensemble.csv",
        "run-setups": "[1]",
        "shared_id": shared_id
    }
        ...
        for srow in range(0, srows):
            ...
            for scol in range(0, scols):
                ...
                env_template["pathToClimateCSV"] = \
                    ...
                    f"brandenburg_ensemble/{gcm}/{rcm}/{scenario}/{ensmem}/{version}/row-{int(crow)}/col-{int(ccol)}.csv.gz"
